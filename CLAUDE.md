...
- 已配准 **7 张**历史图：`chengdu-1903`（清末手绘四川省城街道图）/ `chengdu-1911` / `chengdu-1915`（左右拼幅）/ `chengdu-1933`（首屏默认）/ `chengdu-1944` / `chengdu-1947` / `chengdu-1989`（首张 1949 后地图，美国 CIA 制、PCL 收藏）。
